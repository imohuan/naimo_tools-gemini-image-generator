- 聊天(Chat) > 谷歌 Gemini 接口 > 原生格式 [图片生成 gemini-3-pro-image-preview 控制宽高比 +清晰度]@请求.md ): 官方文档：https://ai.google.dev/gemini-api/docs/image-generation?hl=zh-cn#gemini-image-editing
...
paths:
  /v1beta/models/gemini-3-pro-image-preview:generateContent:
    post:
                ...
                - role: user
                  parts:
                    ...
                    - inline_data:
                        ...
                        data: >-
                          iVBORw0KGgoAAAANSUhEUgAABAAAAAKoCAIAAABm...
              generationConfig:
                responseModalities:
                  - TEXT
                  - IMAGE
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-379838953-run
components:
  schemas: {}
  securitySchemes:
    bearer:
